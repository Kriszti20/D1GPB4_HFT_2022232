using D1GPB4_HFT_2021221.WPFClient;
...
namespace D1GPB4_HFT_2022232.WPFClient
{
    public class MainWindowViewModel : ObservableRecipient
    {
        ...
        public MainWindowViewModel()
        {
            if (!IsInDesignMode)
            {
                Authors = new RestCollection<Author>("http://localhost:40083/", "author", "hub");
                Albums = new RestCollection<Album>("http://localhost:40083/", "album", "hub");
                Songs = new RestCollection<Song>("http://localhost:40083/", "song", "hub");

                Query1 = new RestService("http://localhost:40083/").Get<Song>("stat/QueryOne").Count;
                Query2 = new RestService("http://localhost:40083/").Get<Song>("stat/QueryTwo").Count;
                Query3 = new RestService("http://localhost:40083/").Get<Song>("stat/QueryThree").Count;
